...
OBJS += \
./class/audio/audio_device.o 

C_DEPS += \
./class/audio/audio_device.d 


# Each subdirectory must supply rules for building sources it contributes
class/audio/%.o class/audio/%.su class/audio/%.cyclo: ../class/audio/%.c class/audio/subdir.mk
...
clean: clean-class-2f-audio

clean-class-2f-audio:
	-$(RM) ./class/audio/audio_device.cyclo ./class/audio/audio_device.d ./class/audio/audio_device.o ./class/audio/audio_device.su

.PHONY: clean-class-2f-audio
