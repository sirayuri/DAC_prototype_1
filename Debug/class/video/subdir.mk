...
OBJS += \
./class/video/video_device.o 

C_DEPS += \
./class/video/video_device.d 


# Each subdirectory must supply rules for building sources it contributes
class/video/%.o class/video/%.su class/video/%.cyclo: ../class/video/%.c class/video/subdir.mk
...
clean: clean-class-2f-video

clean-class-2f-video:
	-$(RM) ./class/video/video_device.cyclo ./class/video/video_device.d ./class/video/video_device.o ./class/video/video_device.su

.PHONY: clean-class-2f-video
