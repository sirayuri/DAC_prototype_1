...
OBJS += \
./class/mtp/mtp_device.o 

C_DEPS += \
./class/mtp/mtp_device.d 


# Each subdirectory must supply rules for building sources it contributes
class/mtp/%.o class/mtp/%.su class/mtp/%.cyclo: ../class/mtp/%.c class/mtp/subdir.mk
...
clean: clean-class-2f-mtp

clean-class-2f-mtp:
	-$(RM) ./class/mtp/mtp_device.cyclo ./class/mtp/mtp_device.d ./class/mtp/mtp_device.o ./class/mtp/mtp_device.su

.PHONY: clean-class-2f-mtp
